...
# data = pd.read_csv('/Users/sanakang/Desktop/predict_store/dataset/inter_diningcode.csv')  # Update the path to your file
...
# X_train_scaled의 샘플 수(n_samples)와 특징 수(n_features) 확인
n_samples, n_features = X_train_scaled.shape

# PCA를 위한 최대 n_components 결정
max_n_components = min(n_samples, n_features)

# n_components 리스트 수정
n_components = list(range(1, max_n_components + 1))
