...
youngdeungpo_hashes = pd.read_csv('/Users/sanakang/Downloads/predict_store/dataset/inter_hashes_youngdeungpo_dropped.csv')
jongro_hashes = pd.read_csv('/Users/sanakang/Downloads/predict_store/dataset/inter_hashes_jongro_dropped.csv')
# drop columns
# 003 = {str} 'categories'
# 004 = {str} 'Info Title'
# 005 = {str} 'Title Place'
